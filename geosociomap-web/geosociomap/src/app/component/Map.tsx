...
// const DEFAULT_LOCATION: [number, number] = [100.523186, 13.736717];
mapboxgl.accessToken = process.env.NEXT_PUBLIC_MAPBOX_TOKEN as string;
const Map: React.FC = () => {
  const { points, setPoints, isAddingPoints } = useMapContext();
              ...
              setPoints((prevPoints) => {
                ...
                setHistory((prevHistory) => {
                  ...
                  if (
                    ...
                    return [...prevHistory, updatedPoints]; // บันทึก updatedPoints
                  }
                  return prevHistory;
                });
                updatePolygon(map, updatedPoints);
